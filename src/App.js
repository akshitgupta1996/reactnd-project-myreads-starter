          ...
          <div className="search-books">
            ...
            <div className="list-books">
              ...
              <div className="list-books-content">
                <div>
                  <Bookshelf title={'AK_currentlyReadingBooks'} list={this.state.currentlyReadingBooks}/>
                  <Bookshelf title={'AK_wantToReadBooks'} list={this.state.wantToReadBooks}/>
                  <Bookshelf title={'AK_readBooks'} list={this.state.readBooks}/>
